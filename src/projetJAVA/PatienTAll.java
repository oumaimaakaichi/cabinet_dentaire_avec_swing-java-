...
public class PatienTAll extends JFrame {
	...
	public PatienTAll() {
		...
		panel_1 = new JPanel();
		panel_1.setBounds(300, 188, 953, 381);
		...
		panel_1.setLayout(null);
		 ...
		 String[] columnNames = {"First Name", "Last Name", "Birthdate", "Address", "Profession", "Phone Number" , "medicalcare"};
...
panel_6_1.setBackground(new Color(176, 224, 230));
panel_6_1.setBounds(809, 0, 139, 43);
panel_1.add(panel_6_1);
JLabel lblNewLabel_6_1 = new JLabel("medicalcare");
lblNewLabel_6_1.setForeground(Color.WHITE);
lblNewLabel_6_1.setFont(new Font("Comic Sans MS", Font.BOLD, 16));
panel_6_1.add(lblNewLabel_6_1);
JButton afficher = new JButton("");
afficher.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent e) {
		dispose(); 
		AssistanceAcceuil patients = new AssistanceAcceuil();
...
afficher.setBounds(86, 579, 69, 35);
...
lblNewLabel_8.setIcon(new ImageIcon("C:\\Users\\LENOVO\\Downloads\\e68df15c0793a35e0b1f1871b6ed23a4-removebg-preview (1).png"));
lblNewLabel_8.setBounds(42, 85, 242, 510);
...
update.setBounds(569, 594, 113, 34);
...
btnNewButton.setBounds(715, 594, 113, 34);
...
btnUpdate.setBounds(857, 594, 113, 34);
contentPane.add(btnUpdate);
JLabel lblNewLabel_1_1 = new JLabel("");
lblNewLabel_1_1.setBounds(32, 157, 223, 338);
